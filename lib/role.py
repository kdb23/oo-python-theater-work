...
#  returns all of the auditions associated with this role.
    @property
    def auditions(self):
        return [a.actor for a in Audition.all if a.role == self]
...
#     # returns a string 'no actor has been hired for this role'.
    ...
    # @property
    # def hired_actor(self):
    #     return[a.actor for a in self.auditions if a.hired == True]
    
    # @property
    # def leading_actor(self):
    #     if len(self.hired_actor) > 0:
    #         return "no actor has been hired for this role"
    #     else:
    #         return self.hired_actor[0]
...
#   returns a string 'no actor has been hired for understudy for this role'.
    ...
    # @property
    # def understudy(self):
    #     support = [a for a in self.auditions if a.hired]
    ...
    #         return wish_me_luck
        ...
        # if len(self.the_spare) >= 1:
        #     return self.the_spare[1]
        # else:
        #     return wish_me_luck
